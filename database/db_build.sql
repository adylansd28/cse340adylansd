-- =====================================================================
-- db_build.sql  (Full rebuild of the course schema)
-- Creates TYPE, tables (classification, inventory, account),
-- seeds base data, and runs Task 1 queries 4 and 6 at the end.
-- =====================================================================

-- 0) Safe cleanup (order: drop tables first, then TYPE)
...
-- OPTIONAL: change owner only if the role exists (won't break rebuild)
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'cse340adylansd') THEN
    BEGIN
      ALTER TYPE public.account_type OWNER TO cse340adylansd;
    EXCEPTION WHEN insufficient_privilege THEN
      -- Ignore if you don't have privilege to change the owner
      RAISE NOTICE 'No privilege to change owner of type account_type.';
    END;
  ELSE
    RAISE NOTICE 'Role cse340adylansd does not exist. Skipping owner change.';
  END IF;
END$$;
...
-- 3.1) FK classification -> inventory
...
CREATE TABLE public.account (
    ...
    CONSTRAINT account_email_uniq UNIQUE (account_email)
);

-- 5) Seed data: classification
...
INSERT INTO public.inventory (
  ...
  ('Mystery', 'Machine', '1999',
   ...
   '/images/mystery-van.jpg', '/images/mystery-van-tn.jpg', 10000, 128564, 'Green', 1),
  ...
  ('Ford', 'Crown Victoria', '2013',
   ...
   '/images/crwn-vic.jpg', '/images/crwn-vic-tn.jpg', 10000, 108247, 'White', 5);

-- 7) (Task 1) Query 4 - description replace
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- 8) (Task 1) Query 6 - update image paths
UPDATE public.inventory
